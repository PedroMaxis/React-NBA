...
return(
        <>
<div id={id} className="rounded-xl bg-[#c8c8c8] pt-4 pr-9 pb-[30px] pl-9 flex gap-2.5 items-end justify-center flex-wrap shrink-0 h-[280px] relative overflow-hidden">
    <img className="h-[80px] w-[80px] md:h-[180px] md:w-[190px] shrink-0 " src={logo_url} alt={nome} />

    <div className="flex flex-row gap-2.5">  
        <a href="" className="hover:scale-110 transition ease-in-out delay-100 bg-[#0c0465] rounded-md p-space-300 flex flex-row gap-space-200 items-center justify-center shrink-0 w-[89px] h-6 relative overflow-hidden">
