...
return(
        <>
<div className="rounded-xl bg-[#c8c8c8] pt-4 pr-9 pb-[30px] pl-9 flex gap-2.5 items-end justify-center flex-wrap shrink-0 h-[280px] relative overflow-hidden">
    <img className="h-[80px] object-contain	w-[150px] md:h-[180px] md:w-[190px] shrink-0 " src={logo_url} alt={nome} />
  ...
  <a href={`/jogadores/${nome}`} className="hover:scale-110 transition ease-in-out delay-100 bg-[#303030] rounded-md border-solid border-border-brand-default border p-space-300 flex flex-row gap-space-200 items-center justify-center shrink-0 w-20 md:w-[89px] h-6 relative overflow-hidden">
